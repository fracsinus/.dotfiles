...
globalkeys = gears.table.join(globalkeys,
    ...
    awful.key({ modkey, "Shift" }, "Right",  awful.tag.viewnext,
              {description = "view next", group = "tag"}),
    awful.key({ modkey, }, "Up", function() awful.client.focus.bydirection("up", client.focus) end,
              {description = "Focus up", group = "client"}),
    awful.key({ modkey, }, "Down", function() awful.client.focus.bydirection("down", client.focus) end,
...
-- awful.spawn("picom")
-- awful.spawn.once("VBoxClient-all")
